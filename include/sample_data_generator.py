...
def generate_user_activities_data(users_df, events_per_user=30):
    ...
    event_names = ['session_start', 'page_view', 'add_to_cart', 'purchase', 'session_end']
    devices = ['phone', 'tablet', 'desktop']
    app_versions = ['1.0.6', '1.2.9', '1.5.0', '1.5.5', '1.7.7', '2.0.5', '2.3.3', '2.3.7', '2.4.6', '2.5.0', '2.8.0', '3.1.9', '3.2.0', '3.4.5', '3.8.9']
    ...
    print(f"✅ Generated {len(activities)} activities in user_activities.csv and user_activities.jsonl")
    return df
...
def generate_transactions_sql(users_df, transactions_per_user=10):
    ...
    print(f"✅ Generated {len(transaction_values)} transactions in postgres_transactions_dump.sql")
...
def generate_all_sample_data():
    ...
    print("  • include/datasets/postgres_transactions_dump.sql (contains both users and transactions)")
...
def generate_users_and_transactions_sql():
    ...
    regions = ['Lagos', 'Abuja', 'Kano', 'Oyo', 'Anambra', 'Enugu', 'Edo', 'Rivers', 'Ogun']
    ...
    sql_lines.append("INSERT INTO users (user_id, email, region, signup_channel, created_at) VALUES")
    sql_lines.append(',\n'.join(user_inserts) + ';')
    sql_lines.append("")
    ...
    if transaction_inserts:
        sql_lines.append("INSERT INTO transactions (transaction_id, user_id, amount, currency, status, created_at) VALUES")
    ...
    print(f"✅ Generated users and {len(transaction_inserts)} transactions in postgres_transactions_dump.sql")

def generate_user_activities_csv():
    """Generate user activities CSV file"""
    event_names = ['session_start', 'page_view', 'add_to_cart', 'purchase', 'session_end']
    devices = ['phone', 'tablet', 'desktop'] 
    app_versions = ['1.0.6', '1.2.9', '1.5.0', '1.5.5', '2.0.5', '2.3.3', '2.8.0', '3.1.9']
